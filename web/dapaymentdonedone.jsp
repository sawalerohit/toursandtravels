...
<%
   ...
   try{
    Class.forName("com.mysql.jdbc.Driver");
      ...
      String q="insert into admindpayment (dname,cname,deposit,commission,pdone,ctid,cpm,atid,apm)values("+a+","+b+","+c+","+e+","+d+","+h+","+i+","+f+","+g+")";
      out.println(q);
      st.executeUpdate(q);
      String q1="update dpayment set dflag=1 where tid="+h+"";
      out.println(q1);
