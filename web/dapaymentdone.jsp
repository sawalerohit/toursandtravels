...
<%
    ...
    //  rs=st.executeQuery("select muname from vehicle where vid="+vid+"");
      // rs.next();
       rs=st1.executeQuery("select * from dpayment where dpid="+pid+"");
       rs.next();
...
<html>
  ...
  <script type="text/javascript"> 
    ...
    <body>
       ...
       <form action="dapaymentdonedone.jsp"  method="post">
<br><br><br>
	<div class="row">
			...
			<div class="row">
				...
				<div class="col-lg-3">
                                    <font color="black">Driver User-name*</font>
			</div>
			<div class="col-lg-3">
	...
	<div class="row">
		<div class="col-lg-1"></div>
			<div class="col-lg-3">
				<input type="text" name="muname"  class="form-control" value="<%=rs.getString(3)%>" readonly>
				<p id="a"></p>
			</div>
			<div class="col-lg-3">
				<input type="text" name="cuname" value="<%=rs.getString(5)%>" class="form-control" readonly>
				<p id="b"></p>
			</div>
			<div class="col-lg-3">
				<input type="text" name="deposit" value="<%=rs.getInt(10)%>" class="form-control" readonly>
				<p id="b"></p>
			</div>
			<div class="col-lg-1"></div>
		</div>
		...
		<div class="row">
				...
				<div class="col-lg-3">
					<input type="text" name="tid"  class="form-control" value="">
                                    			</div>
                </div>
                <br><br><br>
                                <div class="row">
				...
				<div class="col-lg-3">
					<input type="text" name="ctid"  class="form-control" value="<%=rs.getString(7)%>" readonly>
                                </div>
                                <div class="col-lg-3">
                                    <input type="text" name="cpm"  class="form-control" value="<%=rs.getString(6)%>" readonly>
                                </div>
                                </div>
			<br><br><br>
                	<div class="row"></div>
