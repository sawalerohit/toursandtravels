...
<%
      ...
      ResultSet rs=st.executeQuery("select * from vehicle where muname="+mmname+"");
      while(rs.next())
      {
          out.println("<tr>");
          int p=rs.getInt(1);
          ...
          out.println("<td><a href=editvehicle.jsp?id="+p+">Edit</a>");
          out.println("<td><a href=deletevehicle.jsp?id="+p+">Delete</a>");
      }
      
      
%>
        </table><br><br>
        <p align="center"><a href="mdashboard.jsp" class="btn btn-primary">Dashboard</a></p>
    </body>
</html>