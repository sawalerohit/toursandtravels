...
<%
    ...
    Class.forName("com.mysql.jdbc.Driver");
      ...
      rs=st.executeQuery("select muname from heavyvehicle where hvid="+vid+"");
       rs.next();
       rs1=st1.executeQuery("select * from hvpayment where pid="+pid+"");
       rs1.next();
...
<html>
  ...
  <script type="text/javascript"> 
    ...
    <body>
       ...
       <form action="aphdone.jsp"  method="post">
<br><br><br>
	<div class="row">
	...
	<div class="row">
		...
		<div class="row">
				...
				<div class="col-lg-3">
					<input type="text" name="ctid"  class="form-control" value="<%=rs1.getString(17)%>" readonly>
                                </div>
                                <div class="col-lg-3">
