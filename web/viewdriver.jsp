...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
     ...
     try
    {
        ...
        ResultSet rs=st.executeQuery("select * from driverregister where dflag=0");
        while(rs.next())
        {
            int p=rs.getInt(1);
            out.println("<tr>");
            ...
            out.println("<td><a href=dapprove.jsp?id="+p+">Approve</a>");
            out.println("<td><a href=dreject.jsp?id="+p+">Reject</a>");
        }
    }
    catch(Exception e)
    {
